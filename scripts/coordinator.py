...
def get(starting_lat, starting_lon, ending_lat, ending_lon):
    url = "https://maps.googleapis.com/maps/api/distancematrix/json?traffic_model=best_guess&origins=%s,%s&destinations=%s,%s&departure_time=now&key=AIzaSyD9Cyy79DLP-pvlVVYB1rBCkZwNfojOhG0" % (starting_lat, starting_lon, ending_lat, ending_lon)
